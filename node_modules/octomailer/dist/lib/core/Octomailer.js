...
class Octomailer {
    ...
    constructor(providers, logger) {
        ...
        if (!providers || providers.length === 0) {
            throw new errors_1.NoProvidersError();
        }
    ...
    send(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (providers.length === 0) {
                throw new errors_1.NoProviderFoundError();
            }
            for (const provider of providers) {
                try {
                    ...
                    this.log(`Failed to send email with ${provider.name}. Error: ${error.message}`);
                }
            }
            throw new errors_1.OctomailerError('All providers failed to send the email.');
        });
    }
    /**
     ...
     */
    selectProvider() {
        const totalWeight = this.providers.reduce((acc, provider) => acc + provider.weight, 0);
        if (totalWeight <= 0) {
